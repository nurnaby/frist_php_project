                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">Service Creat</h5>
                            ...
                            <form class="form-horizontal" action="contorller/serviceContorller.php" method="POST"
                                ...
                                <fieldset class="content-group mt-10">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-2" for="service_detaile"> Service
                                            Detaile</label>
                                        <div class="col-lg-10">
                                            <textarea rows="5" cols="5" class="form-control" placeholder="Details"
                                                id="service_detaile" name="service_detaile"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group mt-10">
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="service_list.php" class="btn btn-default ml-5">Back to List</a>
                                </div>
                            </form>
                        </div>
                    </div>
