                    ...
                    <form action="loginController.php" method="POST">
                        <div class="panel panel-body login-form">
                            <div class="text-center">
                                ...
                                <h5 class="content-group">Password <small class="display-block">We'll send you
                            ...
                            <div class="form-group has-feedback">
                                <input type="password" class="form-control" placeholder="conform password" name="conframPassword">
                                <div class="form-control-feedback">
                                    <i class="icon-mail5 text-muted"></i>
                                </div>
                            </div>

                            <button type="submit" class="btn bg-blue btn-block">Send <i
